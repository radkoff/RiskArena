...
/*
	 * Pretty is the panel where stuff is actually drawn. It is separated from Graphics so that it
	 * is not confused with other future developements like a human input UI
	 */
